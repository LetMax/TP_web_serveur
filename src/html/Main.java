...
public class Main {
    ...
    public static void main (String[] args){
        ...
        post("/viewAllLists/:id/creaSousListe", (req, res) -> {
            ...
            DAO_Liste dao_liste = new DAO_Liste();
            Liste liste = dao_liste.getListeFromId(Integer.parseInt(req.params(":id")));

            if(liste.getIdUser() != getConnectedUser(req).getID()){
                res.redirect("/viewAllLists");
                return "";
            }

            int id_userp = dao_liste.getIdUserFromListe(liste);

            new Liste(titre, description, id_userp, Integer.parseInt(req.params((":id"))));
        ...
        get("/viewAllLists/:id/liste", (req, res) -> {
            ...
            input.put("idint", Integer.parseInt(req.params(":id")));
            input.put("titre", dao_liste.getListeFromId(Integer.parseInt(req.params(":id"))).getTitre());
            input.put("id_liste_mere", dao_liste.getListeFromId(Integer.parseInt(req.params(":id"))).getId_liste_mere());

            List<Liste> sous_listes = dao_liste.getSousListesFromListe(liste);
            input.put("sous_listes", sous_listes.toArray());
        ...
        post("/viewAllLists/:id/edit", (req, res) -> {
            ...
            if(liste.getId_liste_mere() != 0){
                res.redirect("/viewAllLists/"+liste.getId_liste_mere()+"/liste");
            }
            else{
                res.redirect("/viewAllLists");
            }
